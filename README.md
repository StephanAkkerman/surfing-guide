...
> 📸 **Note on images:** The diagrams below are original illustrations built for this guide. If you have real photos or video stills (rip currents at your local beach, your own pop-up sequence, lineup shots), drop them into `images/` and swap the links in — real footage always beats a diagram.
...
![Beach break, point break, and reef break compared](images/spot-types.svg)
...
![How to identify and escape a rip current](images/rip-current-escape.svg)
...
![Four steps of the pop-up: paddle, hand placement, hip drive, athletic stance](images/pop-up-technique.svg)
...
![Lineup priority: the surfer closest to the peak has right of way](images/lineup-priority.svg)
